...
//     >
//       <div
//         className="flex flex-col justify-start items-start rounded-2xl transition-all min-h-[280px] bg-[#f9f9f9] px-5 py-6 w-full max-w-[360px] hover:bg-[#f0f0f0] hover:-translate-y-1"
//       >
//         <h2 className="font-semibold text-[1.1rem] mb-4 px-4 py-2 rounded-xl text-[#333333] leading-snug">
//           160 days gfg Challenge
//         </h2>
...
//       {/* 365 DSA Challenge */}
//       <div
//         className="flex flex-col justify-start items-start rounded-2xl transition-all min-h-[280px] bg-[#f5fafe] px-5 py-6 w-full max-w-[360px] hover:bg-[#e4f2fc] hover:-translate-y-1"
//       >
//         <h2 className="font-semibold text-[1.1rem] mb-4 px-4 py-2 rounded-xl text-[#333333] leading-snug">
//           365 days DSA challenge
//         </h2>
...
//       {/* 130 Days Aptitude Challenge */}
//       <div
//         className="flex flex-col justify-start items-start rounded-2xl transition-all min-h-[280px] bg-[#f9f9f9] px-5 py-6 w-full max-w-[360px] hover:bg-[#ffe9d5] hover:-translate-y-1"
//       >
//         <h2 className="font-semibold text-[1.1rem] mb-4 px-4 py-2 rounded-xl text-[#333333] leading-snug">
//           130 days Aptitude
//         </h2>
