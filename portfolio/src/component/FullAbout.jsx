...
const LordIconWrapper = ({ src, trigger = "hover", style = "width:40px;height:40px" }) => (
  <div
    dangerouslySetInnerHTML={{
      __html: `<lord-icon src="${src}" trigger="${trigger}" style="${style}"></lord-icon>`
    }}
  />
);
